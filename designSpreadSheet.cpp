...
public:
    ...
    int getValue(string formula)
    {
        ...
        formula = formula.substr(1); // removing leading '=' sign

        stringstream ss(formula); // creating stringstream to split formula by '+'
        string token;             // temporary variable to hold part
        int sum = 0;
